...
public class RenderView extends View implements SurfaceHolder {
    ...
    public static int MIN_TREE_SIZE = 1;
    public static int MAX_TREE_SIZE = 10;

    public static int treeSize = 0;


    public static int defaultScreenWidth = 1440;
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mNodePaint.setColor(Color.CYAN);
        ...
        head = new Node(0, screenSize.x / 2, 50, NodeManager.radius); //hard coded for test
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(changeButton==null){
            try {
                changeButton = (Button) this.getRootView().findViewById(R.id.changeButton);
                ...
                changeButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        showNodeValueInput(BinaryMode.Change);
                    }
                });
            } catch (Exception e) {
        ...
        if(deleteButton==null){
            try {
                deleteButton = (Button) this.getRootView().findViewById(R.id.deleteButton);
        ...
        if (resetButton == null) {
            try {
                resetButton = (Button) this.getRootView().findViewById(R.id.Reset_ButtonButton);
                ...
                resetButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        nodeManager = new NodeManager(head);
                        nodeManager.populateTree(head, treeSize);
                        Toast.makeText(getContext(),"Tree sudah direset",Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (Exception e) {
    ...
    public void showNodeValueInput(final BinaryMode mode) {
        ...
        String modeText = (mode == BinaryMode.Insert) ? "Push Node" :
                ...
                (mode == BinaryMode.Change) ? "Change" :
                (mode == BinaryMode.Delete) ? "Delete" :
                        "null operation";
        ...
        dismissButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input.getText().toString().equals("")) {
                    ...
                    if(mode ==BinaryMode.Change){
                        head = new Node(Integer.parseInt(input.getText().toString()), screenSize.x / 2, 50, NodeManager.radius); //hard coded for test
                        head.type = Node.NODE_TYPE_HEAD;
                        head.pos_x -= head.radius;
                    ...
                    else if (mode == BinaryMode.Insert) {

                            nodeManager.insert(head, Integer.parseInt(input.getText().toString()));
                            popupWindow.dismiss();

                    }
                    else if (mode == BinaryMode.Delete) {
                        nodeManager.Delete(head, Integer.parseInt(input.getText().toString()));
                        popupWindow.dismiss();
                    }
        ...
        inLineContainer.setBackgroundColor(0x00000000);
